...
export default function Header({ onBlueBanner = false }: HeaderProps) {
  ...
  <nav className="container mx-auto px-1 sm:px-2 lg:px-2">
    <div className="flex justify-between items-center h-[160rem] px-[10px]">
      <div className="flex items-center">
        <Link to="/" className="flex-shrink-0">
          <img
            src="/logo_de_cote.png"
            alt="Ellipsys"
            className="h-[58rem] sm:h-[112rem] md:h-[128rem] lg:h-[144rem] xl:h-[160rem] 2xl:h-[192rem] w-auto -ml-4 hover:scale-110 transition-transform duration-300 cursor-pointer p-[15px]"
          />
        </Link>
      </div>
