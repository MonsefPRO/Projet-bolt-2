            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 text-center">
              {['facade', 'demoussage', 'hornets', 'industrial2'].map((key, i) => (
                <ScrollReveal delay={0.1 * (i + 1)} key={key}>
                  <Hover3DCard className="bg-white rounded-2xl p-5 md:p-8 shadow-lg border-t-4 border-sky-500 h-full flex flex-col items-center text-center">
            ...
            <div className="container mx-auto px-4 max-w-6xl">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <form className="bg-sky-50 p-6 md:p-8 rounded-3xl border border-sky-100 space-y-4 shadow-lg">
                  ...
                  <button className="w-full bg-[#233B72] text-white py-4 rounded-xl font-bold hover:bg-sky-900 transition-all uppercase tracking-widest text-center">
