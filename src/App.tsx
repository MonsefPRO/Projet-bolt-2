    ...
    <div className="min-h-screen bg-[#EFF8FF]">
      ...
      <header className="fixed w-full bg-white/98 backdrop-blur-md shadow-md z-40 transition-all border-b border-gray-100">
        <nav className="w-full">
          <div className="flex justify-between items-center h-[110px] px-[60px]">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0">
                <img
                  src="/logo_de_cote.png"
                  alt="Ellipsys"
                  className='h-28 sm:h-36 md:h-44 lg:h-56 xl:h-64 2xl:h-72 w-auto hover:scale-110 transition-transform duration-300 cursor-pointer'
                />
              </Link>
            </div>
