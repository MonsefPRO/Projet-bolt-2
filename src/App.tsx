  ...
  return (
    <div className="min-h-screen bg-[#EFF8FF] overflow-x-hidden flex flex-col">
      ...
      <main className="flex-grow">
        <section id="accueil" className="min-h-[70vh] md:min-h-screen pt-28 pb-12 relative overflow-hidden flex items-center">
          ...
          <div className="w-full relative z-20 container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
              <Link to="/devis" className="bg-brand-orange-500 text-white px-8 py-3.5 rounded-xl font-bold text-lg hover:scale-105 transition-all shadow-xl text-center">
                {t('hero.cta')}
              </Link>
        ...
        {/* SECTION PRESTATIONS AVEC COULEURS D'ORIGINE */}
        ...
        {/* SECTION AVIS ET CONTACT (Rétablies) */}
        ...
        <section id="contact" className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-center md:text-left">
              ...
              <form className="bg-sky-50 p-6 md:p-8 rounded-3xl border border-sky-100 space-y-4 shadow-lg text-left">
